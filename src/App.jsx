  ...
  return (
    <div style={{ minHeight: '100vh', background: 'linear-gradient(180deg, #eef2ff, #f8fbff 55%, #ffffff 100%)', padding: '10px 8px 18px' }}>
      <div style={{ width: '100%', maxWidth: '1200px', margin: '0 auto', fontFamily: 'Inter, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif', color: '#111827' }}>
        <header style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '10px 14px', background: 'white', borderRadius: '999px', boxShadow: '0 6px 18px rgba(0,0,0,0.08)', marginBottom: '14px', flexWrap: 'wrap', gap: '8px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            <button style={{ width: '28px', height: '28px', borderRadius: '8px', border: '1px solid #d1d5db', background: 'white', display: 'grid', placeItems: 'center', cursor: 'pointer' }}>☀</button>
            <a href="#" style={{ padding: '6px 12px', borderRadius: '999px', background: '#4f46e5', color: 'white', textDecoration: 'none', fontWeight: 600, fontSize: '0.75rem' }}>Sign up</a>
          </div>
        </header>
